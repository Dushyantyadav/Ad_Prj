...
function onClickPay() 
{
	...
	<h2>List Of Organizations Sponsors</h2>
	<?php
		...
		{
			$res=mysqli_query($db,"SELECT * FROM `organization` ORDER BY `organization`.`in_id` ASC;");

		echo "<table class='table table-bordered table-hover' >";
			echo "<tr style='background-color: #6db6b9e6;'>";
				//Table header
				echo "<th>"; echo "Organization ID";	echo "</th>";
				echo "<th>"; echo "Organization Name";	echo "</th>";
			echo "</tr>";	
			...
			while($row=mysqli_fetch_assoc($res))
			{
				...
				echo "<td>"; echo $row['oname']; echo "</td>";
				echo "</tr>";
			}
		echo "</table>";
		}
