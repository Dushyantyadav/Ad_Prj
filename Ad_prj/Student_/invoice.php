	...
	if(isset($_SESSION['login_user']))
		{
			...
			$q=mysqli_query($db,"SELECT * from invoice where ren_id in (select ren_id from rental where cust_id='$_SESSION[login_user]' );"); 
			//echo "<h1>".$p."</h1>";
		...
		echo "<table class='table table-bordered table-hover' >";
			echo "<tr style='background-color: #6db6b9e6;'>";
				...
				echo "<th>"; echo "Invoice-ID";  echo "</th>";
				echo "<th>"; echo "Inoivr date";  echo "</th>";
			...
			{
				echo "<tr>";
				echo "<td>"; echo $row['inv_no']; echo "</td>";
				echo "<td>"; echo $row['inv_date']; echo "</td>";
				echo "<td>"; echo $row['inv_amt']; echo "</td>";
				echo "<td>"; echo $row['pay_status']; echo "</td>";
				$inv_no = $row['inv_no'];
				if($row['pay_status'] != "Paid"){
				echo "<td> <button style='background-color: #6db6b9e6;' type='submit' name='submit1' 
				onclick=\"onClickPay($inv_no)\"
