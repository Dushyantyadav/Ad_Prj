...
<body>
	<div class="wrapper">
		...
		<form action="" method="post" >
			<input type="text" name="ademailid" class="form-control" placeholder="Email ID" required=""><br>
	...
	<?php
		...
		{
			if(mysqli_query($db,"UPDATE admin SET password='$_POST[password]' WHERE ademailid='$_POST[ademailid]' ;"))
			{
				?>
