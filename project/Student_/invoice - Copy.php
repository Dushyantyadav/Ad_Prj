    ...
    <?php
      ...
      if(isset($_POST['submit']))
      {
        ...
        if($count==0)
        {
		  ...
		  $r=mysqli_query($db,"INSERT INTO payments (pm_date,pm_method, crd_h_fname, crd_h_lname, pm_amt) values (sysdate(),'$_POST[pm_method]','$_POST[crd_h_fname]','$_POST[crd_h_lname]','$_POST[pmt_amt]');") or die(mysqli_error($db));
		  $inv_no = (int)$_GET['q'];
